...
<main class="kaufen registrieren" id="pagetop">
    ...
    <form method="post" action="?festival=1">
        <input type="text" placeholder="Festivalname" name="name">
        <br>
        ...
        <input type="datetime-local" placeholder="Datum Ende" name="ende">
        <br>
        <input type="text" placeholder="Datum Beginn" name="musikrichtung">
        <br>
        <br>
        <br>
        <button type="submit" class="button btnweiss">in DB übernehmen</button>
        <br>
        <?php
        /*    if ($error) {
                echo $error;
    ...
    <form method="post" action="logout.php">
        <button type="submit" class="button btnweiss">logout</button>
    </form>
</main>
